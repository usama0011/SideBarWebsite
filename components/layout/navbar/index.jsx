      ...
      <nav className=" fixed top-0 w-full shadow-lg z-50">
        <div className="w-full text-white  bg-primary-color ">
          <div className="flex flex-col  px-4 mx-auto md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
            ...
            <div className="hidden  laptop:inline-flex items-center  relative rounded-lg">
              <div className="flex items-center relative rounded-lg">
                <SearchIcon className="h-5 absolute  top-2  right-3 pl-1  text-gray-400" />
                <input
                  type="text"
                  placeholder="Search"
                  className=" rounded-lg hidden  laptop:inline-flex text-sm outline-none text-gray-500 pl-3 px-6 py-2"
                />
              </div>
              <div>
                <button
