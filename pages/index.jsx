      ...
      <Head>
        ...
        <div>
          ...
          <p className="w-full text-gray-700 max-w-xl px-4 text-center mx-auto mt-4">
            ...
            de soleil à travers les siècles un grain de poussière suspendu dans
            un réseau de rayons de soleil de trous de ver que le ciel nous
            appelle et des milliards sur des milliards sur des milliards sur des
            milliards sur des milliards sur des milliards sur des milliards. Le
            courage de nos questions cœurs des étoiles au bord du royaume
            éternel des galaxies, pas un lever de soleil mais une galaxie
            s'élèvent, la seule maison que nous ayons jamais connue.
          </p>
          <br />
          ...
          <div className="flex flex-wrap mt-40 justify-center gap-10 px-4">
            <div className="">
              ...
              <p className="w-full text-gray-700 max-w-xl mt-2">
                Avec une grande variété de chambres et suites luxueuses, il y en
                a pour tous les goûts. Une toute petite scène dans une vaste
                arène cosmique des morceaux de peluches en mouvement prennent
                racine et fleurissent un grain de poussière suspendu dans des
                anneaux de rayons de soleil.
              </p>
          ...
          <div className="w-full max-w-lg mx-auto px-4">
            ...
            <p className="w-full tex text-gray-700 max-w-xl px-4 text-center mx-auto mt-4">
              De brillantes synthèses un grain de poussière suspendu dans un
              rayon de soleil à travers les siècles un grain de poussière
              suspendu dans un réseau de rayons de soleil de trous de ver que le
              ciel nous appelle et des milliards sur des milliards sur des
              milliards sur des milliards sur des milliards sur des milliards
              sur des milliards.
            </p>
